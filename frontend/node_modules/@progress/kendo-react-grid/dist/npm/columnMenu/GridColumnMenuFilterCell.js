...
var GridColumnMenuFilterCell = /** @class */ (function (_super) {
    ...
    function GridColumnMenuFilterCell(props) {
        ...
        _this.renderOperatorEditor = function () {
            ...
            return (React.createElement(kendo_react_dropdowns_1.DropDownList, { value: value, onChange: _this.operatorChange, data: _this.props.operators, textField: "text" }));
        };
    ...
    GridColumnMenuFilterCell.prototype.filterComponent = function (filterType, value, booleanValues) {
        ...
        switch (filterType) {
            case 'numeric':
                return (React.createElement(kendo_react_inputs_1.NumericTextBox, { value: value, onChange: function (e) { _this.inputChange(e.value, e.syntheticEvent); }, rangeOnEnter: false }));
            case 'date':
